...
<template>
  <nav
    ...
    <ul
      ...
      <li>
        <div class=" relative mr-[100px]   text-gray-600">
          <input class="border border-gray-300 placeholder-current  w-[450px] h-10 px-5 pr-16  rounded-lg text-sm focus:outline-none dark:bg-gray-500 dark:border-gray-50 dark:text-gray-200 " type="search" name="search" placeholder="Search">
    ...
    <div class="hidden lg:flex">
      <div>
        ...
        <NuxtLink to="/" class=" py-1.5 px-3 m-1 text-center bg-gray-100 border border-gray-300 rounded-md text-black  hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 hidden lg:inline-block ">
          Home
        </NuxtLink>
      </div>
